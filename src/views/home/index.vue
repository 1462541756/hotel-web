          ...
          <div class="out-border">
            ...
            <div style="padding: 40px">
              ...
              <el-row class="font-medium">
                <el-col :span="6" class="overview-item-title">空闲</el-col>
                <el-col :span="6" class="overview-item-title">清洁中</el-col>
                <el-col :span="6" class="overview-item-title">维修中</el-col>
          ...
          <div class="out-border">
            ...
            <div style="padding: 40px">
              <el-row>
                ...
                <el-col :span="6" class="color-danger overview-item-value">2000</el-col>
              </el-row>
              <el-row class="font-medium">
